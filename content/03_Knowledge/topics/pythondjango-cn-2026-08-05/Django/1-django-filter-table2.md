---
type: topic
title: "Django实战：使用django-filter和django-tables2打造美观的管理后台"
date: 2026-08-05
category: Django
source_url: https://pythondjango.cn/django/applications/1-django-filter-table2/
author: 大江狗
tags:
  - Django
  - status/done
...
## 目录
1. [项目演示效果](#%E9%A1%B9%E7%9B%AE%E6%BC%94%E7%A4%BA%E6%95%88%E6%9E%9C)
2. [第一步 安装项目依赖](#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E5%AE%89%E8%A3%85%E9%A1%B9%E7%9B%AE%E4%BE%9D%E8%B5%96)
3. [第二步 创建项目和应用](#%E7%AC%AC%E4%BA%8C%E6%AD%A5-%E5%88%9B%E5%BB%BA%E9%A1%B9%E7%9B%AE%E5%92%8C%E5%BA%94%E7%94%A8)
4. [第三步 编写URLs和视图](#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E7%BC%96%E5%86%99urls%E5%92%8C%E8%A7%86%E5%9B%BE)
5. [第四步 编写模板](#%E7%AC%AC%E5%9B%9B%E6%AD%A5-%E7%BC%96%E5%86%99%E6%A8%A1%E6%9D%BF)
6. [第五步 查看效果](#%E7%AC%AC%E4%BA%94%E6%AD%A5-%E6%9F%A5%E7%9C%8B%E6%95%88%E6%9E%9C)
---
...
## 项目演示效果
下图为Django自带admin对用户管理的界面。 ![image-20210507114454484](../assets/django/applications/1-django-filter-table2.assets/image-20210507114454484.png) 下图是本例使用`django-filter`和`django-tables2`打造的用户管理界面，是不是美观多了? 这个后台支持过滤、重置、按各种字段排序、分页等常见功能。 ![image-20210507114859048](../assets/django/applications/1-django-filter-table2.assets/image-20210507114859048.png)
如果你还不过瘾，可以看下动画效果。
![](../assets/django/applications/1-django-filter-table2.assets/tables_admin.gif)
...
## 第二步 创建项目和应用
先使用`django-admin startproject myproject`创建一个名为`myproject`的应用，接着使用`python manage.py startapp users` 创建一个名为`users`的app，并把它和其它三个项目依赖加入到`settings.py`的INSTALLED\_APPS中去。
```
INSTALLED_APPS = [
...
```
整个项目的布局如下所示：
![image-20210507121138175](../assets/django/applications/1-django-filter-table2.assets/image-20210507121138175.png)
...
![image-20210507124627841](../assets/django/applications/1-django-filter-table2.assets/image-20210507124627841.png)
