---
type: topic
title: "Django实战：使用通用类视图开发任务管理CRUD小应用"
date: 2026-08-05
category: Django
source_url: https://pythondjango.cn/django/applications/2-django-CBV-CRUD-example/
author: 大江狗
tags:
  - Django
  - status/done
...
## 目录
1. [第一步：创建tasks应用，把它加入INSTALLED\_APPS](#%E7%AC%AC%E4%B8%80%E6%AD%A5%E5%88%9B%E5%BB%BAtasks%E5%BA%94%E7%94%A8%E6%8A%8A%E5%AE%83%E5%8A%A0%E5%85%A5installed_apps)
2. [第二步：创建Task模型及其关联表单](#%E7%AC%AC%E4%BA%8C%E6%AD%A5%E5%88%9B%E5%BB%BAtask%E6%A8%A1%E5%9E%8B%E5%8F%8A%E5%85%B6%E5%85%B3%E8%81%94%E8%A1%A8%E5%8D%95)
3. [第三步：编写路由URLConfs及其相关视图函数](#%E7%AC%AC%E4%B8%89%E6%AD%A5%E7%BC%96%E5%86%99%E8%B7%AF%E7%94%B1urlconfs%E5%8F%8A%E5%85%B6%E7%9B%B8%E5%85%B3%E8%A7%86%E5%9B%BE%E5%87%BD%E6%95%B0)
4. [第四步：编写模板](#%E7%AC%AC%E5%9B%9B%E6%AD%A5%E7%BC%96%E5%86%99%E6%A8%A1%E6%9D%BF)
5. [第五步：运行项目，查看效果](#%E7%AC%AC%E4%BA%94%E6%AD%A5%E8%BF%90%E8%A1%8C%E9%A1%B9%E7%9B%AE%E6%9F%A5%E7%9C%8B%E6%95%88%E6%9E%9C)
---
...
![img](../assets/django/applications/2-django-CBV-CRUD-example.assets/633c65787a679a54ce45a57bec7e7788.gif)
## 第一步：创建tasks应用，把它加入INSTALLED\_APPS
首先使用 `python manage.py startapp tasks` 创建一个名为`tasks`的app，并把它计入到`settings.py`的INSTALLED\_APPS中去。
```
INSTALLED_APPS = [
...
## 第四步：编写模板
虽然我们有5个urls，但我们只需要创建4个模板:`task_list.html`, `task_detail.html`、`task_form.html`和`task_confirm_delete.html,` 其中task\_form.html由`task_create` 和`task_update` 视图类共享。我们在模板中对实例对象进行判断，如果对象已存在则模板对于更新任务，否则是创建任务。
```
...
```
整个项目的布局如下所示：
![img](../assets/django/applications/2-django-CBV-CRUD-example.assets/a7d807f7341caaaecec6fa36d1458f24.png)
项目源码地址：
