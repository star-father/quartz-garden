...
date: 2026-08-05
category: Django进阶教程
source_url: https://pythondjango.cn/django/advanced/18-docker-deployment/
author: 大江狗
tags:
  - Django进阶教程
  - status/done
...
# Docker部署Django
## 目录
1. [Docker及Docker-Compose的安装](#docker%E5%8F%8Adocker-compose%E7%9A%84%E5%AE%89%E8%A3%85)
2. [Django + Uwsgi + Nginx + MySQL + Redis组合容器示意图](#django--uwsgi--nginx--mysql--redis%E7%BB%84%E5%90%88%E5%AE%B9%E5%99%A8%E7%A4%BA%E6%84%8F%E5%9B%BE)
3. [Docker-compose部署Django项目布局树形图](#docker-compose%E9%83%A8%E7%BD%B2django%E9%A1%B9%E7%9B%AE%E5%B8%83%E5%B1%80%E6%A0%91%E5%BD%A2%E5%9B%BE)
4. [第一步：编写docker-compose.yml文件](#%E7%AC%AC%E4%B8%80%E6%AD%A5%E7%BC%96%E5%86%99docker-composeyml%E6%96%87%E4%BB%B6)
5. [第二步：编写Web (Django+Uwsgi)镜像和容器所需文件](#%E7%AC%AC%E4%BA%8C%E6%AD%A5%E7%BC%96%E5%86%99web-djangouwsgi%E9%95%9C%E5%83%8F%E5%92%8C%E5%AE%B9%E5%99%A8%E6%89%80%E9%9C%80%E6%96%87%E4%BB%B6)
6. [第三步：编写Nginx镜像和容器所需文件](#%E7%AC%AC%E4%B8%89%E6%AD%A5%E7%BC%96%E5%86%99nginx%E9%95%9C%E5%83%8F%E5%92%8C%E5%AE%B9%E5%99%A8%E6%89%80%E9%9C%80%E6%96%87%E4%BB%B6)
7. [第四步：编写Db (MySQL)容器配置文件](#%E7%AC%AC%E5%9B%9B%E6%AD%A5%E7%BC%96%E5%86%99db-mysql%E5%AE%B9%E5%99%A8%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6)
8. [第五步：编写Redis 容器配置文件](#%E7%AC%AC%E4%BA%94%E6%AD%A5%E7%BC%96%E5%86%99redis-%E5%AE%B9%E5%99%A8%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6)
9. [第六步：修改Django项目settings.py](#%E7%AC%AC%E5%85%AD%E6%AD%A5%E4%BF%AE%E6%94%B9django%E9%A1%B9%E7%9B%AEsettingspy)
10. [第七步：使用docker-compose 构建镜像并启动容器组服务](#%E7%AC%AC%E4%B8%83%E6%AD%A5%E4%BD%BF%E7%94%A8docker-compose-%E6%9E%84%E5%BB%BA%E9%95%9C%E5%83%8F%E5%B9%B6%E5%90%AF%E5%8A%A8%E5%AE%B9%E5%99%A8%E7%BB%84%E6%9C%8D%E5%8A%A1)
11. [第八步：排错](#%E7%AC%AC%E5%85%AB%E6%AD%A5%E6%8E%92%E9%94%99)
    1. [Nginx容器排错](#nginx%E5%AE%B9%E5%99%A8%E6%8E%92%E9%94%99)
    2. [Web容器排错](#web%E5%AE%B9%E5%99%A8%E6%8E%92%E9%94%99)
    3. [数据库db容器排错](#%E6%95%B0%E6%8D%AE%E5%BA%93db%E5%AE%B9%E5%99%A8%E6%8E%92%E9%94%99)
...
这四个容器的别名及通信端口如下图所示：
![image-20210419144633551](../assets/django/advanced/12-internationalization.assets/image-20210419144633551.png)
...
![image-20210419144719353](../assets/django/advanced/12-internationalization.assets/image-20210419144719353.png)
## 第八步：排错
...
uWSGI和Nginx之间有3种通信方式unix socket，TCP socket和http如果Nginx以proxy\_pass方式转发请求，uwsgi需要使用http协议进行通信。如果Nginx以`uwsgi_pass`转发请求，uwsgi建议配置socket进行通信。
### Web容器排错
...
tty: true
```
有时web容器会出现不能连接到数据库的报错，这时需要检查`settings.py`中的数据库配置信息是否正确(比如host为db)，并检查web容器和db容器是否通过`db_network`正常通信(比如进入db容器查看数据表是否已经生成)。在进行数据库迁移时web容器还会出现if table exists or failed to open the referenced table ‘users\_user’, inconsistent migration history的错误, 可以删除migrations目录下文件并进入MySQL容器删除`django_migrations`数据表即可。
### 数据库db容器排错
