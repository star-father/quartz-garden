...
date: 2026-08-05
category: Python进阶实战
source_url: https://pythondjango.cn/python/advanced/2-python-multi-threads-multiprocessing/
author: 大江狗
tags:
  - Python进阶实战
  - status/done
...
# 一文看懂Python多进程与多线程编程
## 目录
1. [什么是进程(process)和线程(thread)?](#%E4%BB%80%E4%B9%88%E6%98%AF%E8%BF%9B%E7%A8%8Bprocess%E5%92%8C%E7%BA%BF%E7%A8%8Bthread)
2. [Python的多进程编程与multiprocess模块](#python%E7%9A%84%E5%A4%9A%E8%BF%9B%E7%A8%8B%E7%BC%96%E7%A8%8B%E4%B8%8Emultiprocess%E6%A8%A1%E5%9D%97)
3. [利用multiprocess模块的Pool类创建多进程](#%E5%88%A9%E7%94%A8multiprocess%E6%A8%A1%E5%9D%97%E7%9A%84pool%E7%B1%BB%E5%88%9B%E5%BB%BA%E5%A4%9A%E8%BF%9B%E7%A8%8B)
4. [多进程间的数据共享与通信](#%E5%A4%9A%E8%BF%9B%E7%A8%8B%E9%97%B4%E7%9A%84%E6%95%B0%E6%8D%AE%E5%85%B1%E4%BA%AB%E4%B8%8E%E9%80%9A%E4%BF%A1)
5. [Python的多线程编程与threading模块](#python%E7%9A%84%E5%A4%9A%E7%BA%BF%E7%A8%8B%E7%BC%96%E7%A8%8B%E4%B8%8Ethreading%E6%A8%A1%E5%9D%97)
6. [通过继承Thread类重写run方法创建新进程](#%E9%80%9A%E8%BF%87%E7%BB%A7%E6%89%BFthread%E7%B1%BB%E9%87%8D%E5%86%99run%E6%96%B9%E6%B3%95%E5%88%9B%E5%BB%BA%E6%96%B0%E8%BF%9B%E7%A8%8B)
7. [不同线程间的数据共享](#%E4%B8%8D%E5%90%8C%E7%BA%BF%E7%A8%8B%E9%97%B4%E7%9A%84%E6%95%B0%E6%8D%AE%E5%85%B1%E4%BA%AB)
8. [使用queue队列通信-经典的生产者和消费者模型](#%E4%BD%BF%E7%94%A8queue%E9%98%9F%E5%88%97%E9%80%9A%E4%BF%A1-%E7%BB%8F%E5%85%B8%E7%9A%84%E7%94%9F%E4%BA%A7%E8%80%85%E5%92%8C%E6%B6%88%E8%B4%B9%E8%80%85%E6%A8%A1%E5%9E%8B)
9. [Python多进程和多线程哪个快?](#python%E5%A4%9A%E8%BF%9B%E7%A8%8B%E5%92%8C%E5%A4%9A%E7%BA%BF%E7%A8%8B%E5%93%AA%E4%B8%AA%E5%BF%AB)
10. [小结](#%E5%B0%8F%E7%BB%93)
---
...
1. `map_async()`
函数原型：`map_async(func, iterable[, chunksize[, callback]])` 与map用法一致，但是它是非阻塞的。其有关事项见apply\_async。
1. `close()`
...
python 3中的多进程编程主要依靠threading模块。创建新线程与创建新进程的方法非常类似。`threading.Thread`方法可以接收两个参数, 第一个是target，一般指向函数名，第二个时args，需要向函数传递的参数。对于创建的新线程，调用start()方法即可让其开始。我们还可以使用current\_thread().name打印出当前线程的名字。 下例中我们使用多线程技术重构之前的计算代码。
```
import threading
import time
def long_time_task(i):
...
本文由大江狗原创，全文转载请注明来源。我是大江狗，一名Python Web开发与Django技术开发爱好者。您可以通过搜索【[CSDN大江狗](https://blog.csdn.net/weixin_42134789)】、【[知乎大江狗](https://www.zhihu.com/people/shi-yun-bo-53)】和搜索微信公众号【Python Web与Django开发】关注我！
