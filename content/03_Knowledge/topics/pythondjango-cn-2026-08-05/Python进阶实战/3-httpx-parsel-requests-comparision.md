...
date: 2026-08-05
category: Python进阶实战
source_url: https://pythondjango.cn/python/advanced/3-httpx-parsel-requests-comparision/
author: 大江狗
tags:
  - Python进阶实战
  - status/done
...
## 目录
1. [requests + BeautifulSoup](#requests--beautifulsoup)
2. [requests + parsel组合](#requests--parsel%E7%BB%84%E5%90%88)
3. [httpx同步 + parsel组合](#httpx%E5%90%8C%E6%AD%A5--parsel%E7%BB%84%E5%90%88)
4. [httpx异步协程 + parsel](#httpx%E5%BC%82%E6%AD%A5%E5%8D%8F%E7%A8%8B--parsel)
5. [httpx 多进程 + parsel 组合](#httpx-%E5%A4%9A%E8%BF%9B%E7%A8%8B--parsel-%E7%BB%84%E5%90%88)
6. [httpx 多线程 + parsel 组合](#httpx-%E5%A4%9A%E7%BA%BF%E7%A8%8B--parsel-%E7%BB%84%E5%90%88)
7. [对比与总结](#%E5%AF%B9%E6%AF%94%E4%B8%8E%E6%80%BB%E7%BB%93)
---
...
```
注意：我们使用了fake\_useragent, requests和BeautifulSoup，这些都需要通过pip事先安装好才能用。
现在我们来看下爬取结果，耗时约18.5秒，总共爬取580条数据。
![image-20210509213732369](../assets/python/advanced/2021-05-19-django-basics-tutorials.assets/image-20210509213732369.png)
![image-20210509213712357](../assets/python/advanced/2021-05-19-django-basics-tutorials.assets/image-20210509213712357.png)
## requests + parsel组合
...
![image-20210509215716661](../assets/python/advanced/2021-05-19-django-basics-tutorials.assets/image-20210509215716661.png)
## httpx同步 + parsel组合
...
![image-20210509220445432](../assets/python/advanced/2021-05-19-django-basics-tutorials.assets/image-20210509220445432.png)
...
![image-20210509221719632](../assets/python/advanced/2021-05-19-django-basics-tutorials.assets/image-20210509221719632.png)
            ...
            with open(self.path, 'w', newline='', encoding='utf_8_sig') as csv_file:
                ...
                while not self.q.empty():
                    ...
                    if item:
                        ...
                        writer.writerow(row_data)
```
项目运行效果如下所示，多进程爬取580条数据总共耗时7.6秒。 ![image-20210510174206013](../assets/python/advanced/2021-05-19-httpx-parsel-requests-comparision.assets/image-20210510174206013.png)
项目完整代码如下所示：
```
from fake_useragent import UserAgent
import csv
...
![image-20210510175803285](../assets/python/advanced/2021-05-19-httpx-parsel-requests-comparision.assets/image-20210510175803285.png)
